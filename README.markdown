...
<table class="table" width="100%">
  ...
  <tr>
    ...
    <td>This function is fired as soon as the overlay is loaded allowing you to pass through your custom tracking ID (max 250 characters long) that can be received after a successful purchase within <a href="https://selz.com/support/using-webhooks-selz" target="_blank">webhook</a> or in your dashboard order detail page. The function gets passed a single argument, a jQuery object for the link that triggered the overlay.</td>
  </tr>
  <tr>
...
```html
<link href="https://cdn.selz.com/jquery/1.0.6/jquery.selz.min.css" rel="stylesheet">
<script src="https://cdn.selz.com/jquery/1.0.6/jquery.selz.min.js"></script>
```
